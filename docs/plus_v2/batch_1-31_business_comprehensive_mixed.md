...
### 기본 요청
```
business 도메인 종합: presentation, negotiation, contracts, finance, marketing, teamwork, leadership, planning, reports, emails, sales, management 카테고리 포함, 기초 50% + 중급 50%에 대한 다국어 학습 데이터를 50개 생성해주세요.
...
5. **종합적 접근**: business 도메인 종합: presentation, negotiation, contracts, finance, marketing, teamwork, leadership, planning, reports, emails, sales, management 카테고리 포함, 기초 50% + 중급 50%
