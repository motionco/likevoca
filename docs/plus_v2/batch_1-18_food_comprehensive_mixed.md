...
### 기본 요청
```
food 도메인 종합: fruits, vegetables, desserts, meat, dairy, spices, dining, recipes 카테고리 포함, 기초 70% + 중급 30%에 대한 다국어 학습 데이터를 50개 생성해주세요.
...
2. **데이터 수**: 50개
3. **난이도**: 혼합 (비율은 설명에 명시)
4. **품사 분포**: 명사(noun) 40%, 형용사(adjective) 30%, 동사(verb) 30%
5. **종합적 접근**: food 도메인 종합: fruits, vegetables, desserts, meat, dairy, spices, dining, recipes 카테고리 포함, 기초 70% + 중급 30%
