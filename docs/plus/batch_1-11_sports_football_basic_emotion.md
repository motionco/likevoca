# AI 데이터 생성 프롬프트 - Batch 1-11: Sports Football Basic Emotion
...
**생성 요구사항:**
1. concept_id 형식: sports_{word}_{meaning} (예: sports_goal_score)
...
8. **주제 집중**: 축구 경기 중 감정 표현, 승부에 대한 반응, 응원 표현 등을 포함해주세요

**1단계 (기초 구축) 특화 요구사항:**
- 일상생활 필수 표현 우선 (기본 감탄사, 감사, 응원, 기본 질문)
- 기초 어휘 중심 (승리, 패배, 골, 경기, 선수)
- 단순한 문법 구조 (현재시제, be동사, 기본 조사)
- 모든 도메인에서 기초 개념 균등 분배

**발음 표기법 (통합_데이터_가이드.md 준수):**
- **Korean**: gol, seung-ri (하이픈 구분, 로마자)
- **English**: /ɡoʊl/, /wɪn/ (IPA 표기)
- **Chinese**: jin qiu, sheng li (pinyin, 성조 없음)
- **Japanese**: gooru, kachi (로마자 헵번식)
- **Spanish**: gol, ga-nar (하이픈 구분, 로마자)
