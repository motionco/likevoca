...
function getTranslatedText(key, lang) {
  ...
  const translations = {
    ...
    es: {
      ...
      emoji_placeholder: "Seleccionar Emoji",
      // 도메인 번역
      daily: "Vida Diaria",
      business: "Negocios",
      education: "Educación",
      ...
      online_learning: "Aprendizaje en Línea",
      training: "Entrenamiento",
      certification: "Certificación",
      educational_technology: "Tecnología Educativa",
      ...
      folklore: "Folclore",
      mythology: "Mitología",
      arts_crafts: "Artes y Manualidades",
      etiquette: "Etiqueta",
      national_identity: "Identidad Nacional",
      // other 카테고리들
      hobbies: "Pasatiempos",
      finance_personal: "Finanzas Personales",
      legal: "Legal",
      government: "Gobierno",
      politics: "Política",
      media: "Medios",
