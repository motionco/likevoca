...
const translations = {
  ko: {
    ...
    representative_example_desc: "(필수 - 개념을 가장 잘 보여주는 예문)",
  ...
  en: {
    ...
    representative_example_desc:
      "(Required - Example that best shows the concept)",
    ...
    purpose_emotion: "Emotion",
    purpose_question: "Question",
    purpose_instruction: "Instruction",
    purpose_cultural: "Cultural Knowledge",
    purpose_professional: "Professional",
    purpose_casual: "Casual",
    situation: "Situation",
    situation_formal: "Formal",
    situation_casual: "Casual",
    situation_business: "Business",
    situation_educational: "Educational",
    situation_social: "Social",
    situation_family: "Family",
    situation_travel: "Travel",
    situation_shopping: "Shopping",
    situation_dining: "Dining",
  ...
  ja: {
    ...
    tags: "タグ (カンマ区切り)",
    // 新しいフィールドの翻訳
    representative_example_desc: "(必須 - 概念を最もよく示す例文)",
    purpose: "目的",
    select_purpose: "目的を選択",
    purpose_description: "説明",
    purpose_action: "行動",
    purpose_emotion: "感情",
    purpose_question: "質問",
    purpose_instruction: "指示",
    purpose_cultural: "文化的知識",
    purpose_professional: "専門的",
    purpose_casual: "日常的",
    situation: "状況",
    situation_formal: "正式",
    situation_casual: "日常",
    situation_business: "ビジネス",
    situation_educational: "教育",
    situation_social: "社会的",
    situation_family: "家族",
    situation_travel: "旅行",
    situation_shopping: "ショッピング",
    situation_dining: "食事",
