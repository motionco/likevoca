...
async function showAIConceptSelectionModal() {
  return new Promise((resolve) => {
    ...
    const categoryTranslations = {
      ...
      golf: { ko: "골프", en: "Golf", ja: "ゴルフ", zh: "高尔夫", es: "Golf" },
      martial_arts: {
        ko: "무술",
        en: "Martial Arts",
        ja: "武術",
      ...
      music: { ko: "음악", en: "Music", ja: "音楽", zh: "音乐", es: "Música" },
      game: { ko: "게임", en: "Game", ja: "ゲーム", zh: "游戏", es: "Juego" },
      book: { ko: "책", en: "Book", ja: "本", zh: "书籍", es: "Libro" },
      art: { ko: "예술", en: "Art", ja: "芸術", zh: "艺术", es: "Arte" },
      theater: {
        ko: "연극",
        en: "Theater",
        ja: "演劇",
      ...
      legal: { ko: "법률", en: "Legal", ja: "法律", zh: "法律", es: "Legal" },
      government: {
        ko: "정부",
        en: "Government",
        ja: "政府",
      ...
      thesis: { ko: "논문", en: "Thesis", ja: "論文", zh: "论文", es: "Tesis" },

      other: { ko: "기타", en: "Other", ja: "その他", zh: "其他", es: "Otro" },
    };
