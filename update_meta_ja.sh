...
# Function to update meta tags for Japanese HTML files
update_meta_tags_ja() {
    local file_path="$1"
    local lang_code="ja"
    local page_name="$2"
    ...
    [[ -z "$description" ]] && description="LikeVoca - 多言語学習プラットフォーム"
...
echo "📂 Processing Japanese (ja) files..."
update_meta_tags_ja "./locales/ja/my-word-list.html" "my-word-list.html"
update_meta_tags_ja "./locales/ja/progress.html" "progress.html"
update_meta_tags_ja "./locales/ja/inquiry.html" "inquiry.html"
update_meta_tags_ja "./locales/ja/profile.html" "profile.html"
update_meta_tags_ja "./locales/ja/login.html" "login.html"
update_meta_tags_ja "./locales/ja/forgotpassword.html" "forgotpassword.html"
update_meta_tags_ja "./locales/ja/privacy.html" "privacy.html"
update_meta_tags_ja "./locales/ja/signup.html" "signup.html"
update_meta_tags_ja "./locales/ja/terms.html" "terms.html"
update_meta_tags_ja "./locales/ja/about.html" "about.html"
update_meta_tags_ja "./locales/ja/faq.html" "faq.html"
update_meta_tags_ja "./locales/ja/manual.html" "manual.html"

echo "🎉 Japanese files completed!"